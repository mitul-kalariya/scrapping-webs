...
from crwrecordnews.constant import LOGGER, SITEMAP_URL, TODAYS_DATE
from crwrecordnews.items import ArticleData
from crwrecordnews.utils import (
    create_log_file,
...
class RecordNewsOnlineSpider(scrapy.Spider, BaseSpider):
    name = "record_news"
    ...
    def __init__(self, *args, type=None, url=None, since=None, until=None, **kwargs):
        ...
        **kwargs: Additional keyword arguments to be passed to the superclass constructor.
        ...
        """
        super(RecordNewsOnlineSpider, self).__init__(*args, **kwargs)
        self.output_callback = kwargs.get("args", {}).get("callback", None)
        proxy_test = json.loads(kwargs['proxies'])
        self.proxies = proxy_test
        self.start_urls = []
        self.articles = []
