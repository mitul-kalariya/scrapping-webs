...
from crwnikkeinews.spiders.nikkei_news import NikkeiNewsSpider
from crwnikkeinews.test.helpers.constant import SITEMAP_URL, TEST_ARTICLES
from crwnikkeinews.test.helpers.utils import (get_article_content,
...
class TestArticle(unittest.TestCase):
    ...
    def test_parse(self):
        for article in TEST_ARTICLES:
            ...
            spider = NikkeiNewsSpider(type="article", url=article["url"])
