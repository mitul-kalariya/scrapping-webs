...
from crwhuffpost.spiders.huff_post import HuffPostSpider
from crwhuffpost.test.helpers.constant import SITEMAP_URL, TEST_ARTICLES
from crwhuffpost.test.helpers.utils import (get_article_content,
...
class TestArticle(unittest.TestCase):
    ...
    def test_parse(self):
        for article in TEST_ARTICLES:
            ...
            spider = HuffPostSpider(type="article", url=article["url"])
