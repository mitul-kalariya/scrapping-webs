...
from crwjtbcnewsonline.test.helpers.constant import SITEMAP_URL, TEST_ARTICLES
from crwjtbcnewsonline.test.helpers.utils import (get_article_content,
...
class TestArticle(unittest.TestCase):
    ...
    def test_parse(self):
        for article in TEST_ARTICLES:
            ...
            spider = JTBCSpider(type="article", url=article["url"])
