...
# TODO: Update the path here replace crwyohapnews --> your project name
from crwyohapnews.spiders.yohapnewstv import YohapNewsSpider
from crwyohapnews.test.helpers.constant import LINK_FEED_URL, TEST_ARTICLES
from crwyohapnews.test.helpers.utils import (
    get_article_content,
...
class TestArticle(unittest.TestCase):
    ...
    def test_parse(self):
        for article in TEST_ARTICLES:
            ...
            spider = YohapNewsSpider(type="article", url=article["url"])
