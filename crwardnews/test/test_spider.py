...
from crwardnews.spiders.ard_news import ArdNewsSpider
from crwardnews.test.helpers.constant import SITEMAP_URL, TEST_ARTICLES
from crwardnews.test.helpers.utils import (get_article_content,
...
class TestArticle(unittest.TestCase):
    ...
    def test_parse(self):
        for article in TEST_ARTICLES:
            ...
            spider = ArdNewsSpider(type="article", url=article["url"])
