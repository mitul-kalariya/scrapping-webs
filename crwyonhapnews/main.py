...
from crwyonhapnews import exceptions
...
class Crawler:
    ...
    def start_crawler(self, query, output_queue):
        ...
        process_settings["DOWNLOADER_MIDDLEWARES"][ "crwyonhapnews.middlewares.CustomProxyMiddleware"] = 110
        ...
        process.crawl(YonhapNewsSpider, **spider_args)
        process.start()
