"""Spider to scrap Yonhap News online (KR) website"""
...
from crwyonhapnews.items import ArticleData
from crwyonhapnews.utils import (
    validate,
    get_raw_response,
    get_parsed_json,
...
from crwyonhapnews.exceptions import (
...
class YonhapNewsSpider(scrapy.Spider, BaseSpider):
