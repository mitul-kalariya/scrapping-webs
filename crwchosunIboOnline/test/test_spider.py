...
from crwchosunIboOnline.spiders.chosun_ibo import ChosunIboOnline
from crwchosunIboOnline.test.helpers.constant import SITEMAP_URL, TEST_ARTICLES
from crwchosunIboOnline.test.helpers.utils import (get_article_content,
                                                   online_response_from_url)
from crwchosunIboOnline import Crawler
...
class TestArticle(unittest.TestCase):
    ...
    def test_parse(self):
        for article in TEST_ARTICLES:
            ...
            spider = ChosunIboOnline(type="article", url=article["url"])
