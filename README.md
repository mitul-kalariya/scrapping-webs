# KBS News online (KR) Scrapping

#### Setup and execution instructions: - 

This repo contains the code to scrap all article links and articles from https://news.kbs.co.kr/ website and the tech stacks used are
- Python 3.10
- Scrapy
...
crawler = Crawler(
    query={
        "type": "article",
        "link": https://news.kbs.co.kr/news/view.do?ncd=7646022
    },
    proxies=proxies
)
