...
from crwtheglobeandmail.spiders.the_globe_and_mail import TheGlobeAndMailSpider
from crwtheglobeandmail.test.helpers.constant import SITEMAP_URL, TEST_ARTICLES
from crwtheglobeandmail.test.helpers.utils import (get_article_content,
...
class TestArticle(unittest.TestCase):
    ...
    def test_parse(self):
        for article in TEST_ARTICLES:
            ...
            spider = TheGlobeAndMailSpider(type="article", url=article["url"], args={'callback': None})
...
class TestSitemap(unittest.TestCase):
    def setUp(self):
        self.type = "sitemap"
        self.spider = TheGlobeAndMailSpider(type=self.type, args={'callback': None})
