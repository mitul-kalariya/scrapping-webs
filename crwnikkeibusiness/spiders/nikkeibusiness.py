...
from crwnikkeibusiness.constant import LOGGER, SITEMAP_URL, TODAYS_DATE
from crwnikkeibusiness.items import ArticleData
from crwnikkeibusiness.utils import (
    create_log_file,
...
class NikkeiBusiness(scrapy.Spider, BaseSpider):
    name = "nikkei_asia"
    ...
    def __init__(self, *args, type=None, url=None, since=None, until=None, **kwargs):
        ...
        **kwargs: Additional keyword arguments to be passed to the superclass constructor.
        ...
        """
        super(NikkeiBusiness, self).__init__(*args, **kwargs)
