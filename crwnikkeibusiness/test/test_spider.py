...
# TODO: Update the path here replace crwnikkeibusiness --> your project name
from crwnikkeibusiness.spiders.nikkeibusiness import NikkeiBusiness
from crwnikkeibusiness.test.helpers.constant import SITEMAP_URL, TEST_ARTICLES
from crwnikkeibusiness.test.helpers.utils import (get_article_content,
...
class TestArticle(unittest.TestCase):
    ...
    def test_parse(self):
        for article in TEST_ARTICLES:
            ...
            spider = NikkeiBusiness(type="article", url=article["url"])
