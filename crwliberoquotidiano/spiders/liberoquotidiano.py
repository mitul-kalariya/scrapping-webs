...
from crwliberoquotidiano import exceptions
from crwliberoquotidiano.constant import SITEMAP_URL, LOGGER, TODAYS_DATE
from crwliberoquotidiano.items import ArticleData
from crwliberoquotidiano.utils import (
...
class LiberoquotidianoSpider(scrapy.Spider, BaseSpider):
    """Spider"""
    ...
    def __init__(self, *args, type=None, url=None, since=None, until=None, **kwargs):
        ...
        """
        try:
            super(LiberoquotidianoSpider, self).__init__(*args, **kwargs)
