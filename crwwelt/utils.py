...
language_mapper = {"en": "English", "de": "German"}
...
def get_parsed_data(response: str, parsed_json_main: list) -> dict:
    ...
    parsed_data_dict |= {
        ...
        "alternative_title": [data_dict.get("alternative_title")],
        "text": [" ".join(text)],
...
def get_author_and_publisher_details(block: dict) -> dict:
    ...
    data_dict = {
        ...
        "alternative_title": block.get('alternativeHeadline'),
        ...
        "category": block.get('articleSection')
    }
