...
from crworientaldaily.test.helpers.constant import SITEMAP_URL, TEST_ARTICLES
from crworientaldaily.test.helpers.utils import (get_article_content,
...
class TestArticle(unittest.TestCase):
    ...
    def test_parse(self):
        for article in TEST_ARTICLES:
            ...
            spider = OrientalDailySpider(type="article", url=article["url"])
