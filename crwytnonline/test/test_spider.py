...
from crwytnonline.test.helpers.constant import SITEMAP_URL, TEST_ARTICLES
from crwytnonline.test.helpers.utils import get_article_content, online_response_from_url
...
class TestArticle(unittest.TestCase):
    ...
    def test_parse(self):
        for article in TEST_ARTICLES:
            ...
            spider = YTNOnlineSpider(type="article", url=article["url"])
